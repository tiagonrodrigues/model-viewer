...
declare class ModelScene extends Scene$1 {
    ...
    private mixerEventSubscriptions;
    ...
    private setupScene;
    updateModelTransforms(index: number, offset?: string | null, orientation?: string | null, scale?: string | null): void;
    /**
...
declare class TextureUtils {
    ...
    loadImage(url: string, withCredentials: boolean, type?: string): Promise<Texture$4>;
    private loadKTX2;
...
interface ContextLostEvent extends Event$1 {
    type: 'contextlost';
...
declare class Renderer extends EventDispatcher<{
    ...
    onWebGLContextLost: (event: Event$1) => void;
...
declare const $onExtraModelChanged: unique symbol;
...
declare class ModelViewerElementBase extends ReactiveElement {
    ...
    [$onSlotChange]: () => void;
    [$onExtraModelChanged]: (event: Event) => void;
 ...
 */
declare class Sampler$1 extends ThreeDOMElement implements Sampler$2 {
 ...
 */
declare class Texture$1 extends ThreeDOMElement implements Texture$2 {
    private [$image];
    private [$sampler];
 ...
 */
declare class TextureInfo$1 implements TextureInfo$2 {
    private [$texture];
    private [$transform];
    private [$materials$1];
    private [$usage];
 ...
 */
declare class PBRMetallicRoughness$1 extends ThreeDOMElement implements PBRMetallicRoughness$2 {
    ...
    get baseColorTexture(): TextureInfo$1;
    get metallicRoughnessTexture(): TextureInfo$1;
    setBaseColorFactor(rgba: RGBA | string): void;
    setMetallicFactor(value: number): void;
    setRoughnessFactor(value: number): void;
}
 ...
 * Material facade implementation for Three.js materials
 */
declare class Material$1 extends ThreeDOMElement implements Material$2 {
    ...
    get name(): string;
    set name(name: string);
    get pbrMetallicRoughness(): PBRMetallicRoughness$1;
    get normalTexture(): TextureInfo$1;
    get occlusionTexture(): TextureInfo$1;
    get emissiveTexture(): TextureInfo$1;
    ...
    get clearcoatTexture(): TextureInfo$1;
    get clearcoatRoughnessTexture(): TextureInfo$1;
    get clearcoatNormalTexture(): TextureInfo$1;
    ...
    get sheenColorTexture(): TextureInfo$1;
    get sheenRoughnessFactor(): number;
    get sheenRoughnessTexture(): TextureInfo$1;
    setSheenColorFactor(rgb: RGB$1 | string): void;
    setSheenRoughnessFactor(roughness: number): void;
    get transmissionFactor(): number;
    get transmissionTexture(): TextureInfo$1;
    setTransmissionFactor(transmission: number): void;
    get thicknessFactor(): number;
    get thicknessTexture(): TextureInfo$1;
    ...
    get anisotropyTexture(): TextureInfo$1;
    setAnisotropyStrength(strength: number): void;
    setAnisotropyRotation(rotation: number): void;
}
...
declare class PrimitiveNode extends Node$1 {
    mesh: Mesh$1;
    materials: Map<number, Material$1>;
    private variantToMaterialMap;
    initialMaterialIdx: number;
    private activeMaterialIdx;
    private modelVariants;
    private parser;
    constructor(mesh: Mesh$1, mvMaterials: Material$1[], modelVariants: Map<string, VariantData>, correlatedSceneGraph: CorrelatedSceneGraph);
    setActiveMaterial(material: number): Promise<Material$4 | null>;
    getActiveMaterial(): Material$1;
    getMaterial(index: number): Material$1 | undefined;
    enableVariant(name: string | null): Promise<Material$4 | null>;
    private enableVariantHelper;
    instantiateVariants(): Promise<void>;
    get variantInfo(): Map<number, Material$1>;
    addVariant(materialVariant: Material$1, variantName: string): boolean;
...
declare class Model implements Model$1 {
    ...
    [$materialFromPoint](hit: Intersection<Object3D>): Material$1 | null;
    /**
    ...
    [$cloneMaterial](index: number, newMaterialName: string): Material$1;
 ...
 */
declare class ExtraModelElement extends ReactiveElement {
    static get is(): string;
    src: string | null;
    /**
...
interface SceneGraphInterface {
    ...
    createTexture(uri: string, type?: string): Promise<Texture$1 | null>;
    createLottieTexture(uri: string, quality?: number): Promise<Texture$1 | null>;
    createVideoTexture(uri: string): Texture$1;
    createCanvasTexture(): Texture$1;
    /**
     ...
     */
    materialFromPoint(pixelX: number, pixelY: number): Material$1 | null;
}
